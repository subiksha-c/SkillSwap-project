...
2. **Connect to your MySQL server** using:
   ...
   - Port: `3306`
   - Username: `root`
   - Password: `1234567` (or your MySQL password)
...
-- Create chat_messages table (NEW)
...
## ✅ Once database is set up, the backend server can be started!
